...
function updateCartTotal() {
    ...
    if(JSON.parse(localStorage.getItem('banklogs')).length == 1) {
        ...
        `;
        document.getElementById('discount-title').innerHTML = `10% Discount on 2 Banklogs`;
        ...
        document.getElementById('modal-amount').innerHTML = `
            ...
            $<span id="omanyala" class="countup">${disTot}</span>
        `;
        document.getElementById('bitcoin-logo').style.display = 'none';
        document.getElementById('discount-title').innerHTML = `10% Discount on ${JSON.parse(localStorage.getItem('banklogs')).length} Banklogs`;
    } 
